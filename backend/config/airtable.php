...
return [
    ...
    'tables' => [
        'Company' => [
            'name' => env('AIRTABLE_COMPANY_TABLE', 'Company'),
        ],
        'Employee'=>[
            'name' => env('AIRTABLE_EMPLOYEE_TABLE', 'Employee'),
        ],
        'token_table'=>[
            'name' => env('AIRTABLE_TOKEN_TABLE','token_table')
        ],
        'Documents'=>[
            'name' => env('AIRTABLE_DOCUMENTS_TABLE','Documents')
        ],
        'Equipe'=>[
            'name' => env('AIRTABLE_TEAMS_TABLE','Equipe')
        ],
        'Demande'=>[
            'name' => env('AIRTABLE_DEMANDS_TABLE','Demande')
        ],
        'Folders'=>[
            'name' => env('AIRTABLE_FOLDERS_TABLE','Folders')
        ],
        'Poste'=>[
            'name' => env('AIRTABLE_FOLDERS_TABLE','Poste')
        ],
        'MotifsDemande'=>[
            'name' => env('AIRTABLE_FOLDERS_TABLE','MotifsDemande')
        ],
        'Password_reset'=>[
            'name' => env('AIRTABLE_PASSWORD_RESETS_TABLE', 'Password_reset')
        ],
        'ActivityLog'=>[
            'name' => env('AIRTABLE_PASSWORD_ACTIVITY_LOG', 'ActivityLog')
        ],
    ],
